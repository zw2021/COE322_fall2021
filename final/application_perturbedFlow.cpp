...
int main() {
    ...
    vector<double> data1 = perturbedShear_calculator( 8, y_max, x, z, mu);//Shear Matrix, water.
    vector<double> data2 = surfaceRoughnes_calculator( 8, y_max, x, z, mu);//Shear Matrix, water.
    //for (auto jj : lda){
